...
#include <iostream>
#include <stdexcept>
#include "data_structures/deque_with_array.h"

void test_empty_deque_behavior()
{
	DataStructures::DequeWithArray<int> dq;
...
{
	DataStructures::DequeWithArray<std::string> dq;
	dq.add_last("end");
	dq.add_first("start");
	dq.add_last("final");
...
int main()
{
	...
	std::cout << "All DequeWithArray tests passed!\n";
	return 0;
}
