...
#include <iostream>
#include <stdexcept>
#include "data_structures/deque_with_linked_list.h"

void test_empty_deque_behavior()
{
	DataStructures::DequeWithLinkedList<int> dq;
...
{
	DataStructures::DequeWithLinkedList<std::string> dq;
	dq.add_last("end");
	dq.add_first("start");
	dq.add_last("final");
...
int main()
{
	...
	std::cout << "All DequeWithLinkedList tests passed!\n";
	return 0;
}
