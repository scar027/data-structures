...
#include <iostream>
#include <stdexcept>
#include "data_structures/queue_with_linked_list_stl.h"

void test_push_and_size()
{
	DataStructures::QueueWithLinkedListSTL<int> q;
	assert(q.size() == 0);
	q.push(10);
	q.push(20);
	q.push(30);
...
int main()
{
	try {
		...
		std::cout << "All QueueWithLinkedListSTL tests passed.\n";
		return 0;
	} catch (...) {
		std::cerr << "A QueueWithLinkedListSTL test failed.\n";
		return 1;
	}
}
